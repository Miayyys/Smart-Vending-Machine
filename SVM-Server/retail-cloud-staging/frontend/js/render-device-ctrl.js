...
(function () {
  ...
  var API = App.API;
  var history = JSON.parse(localStorage.getItem('ctrl_history') || '[]');
  ...
  var PRESETS = [
    ...
    { label: '同步拍照', topic: 'retail/{dev}/cmd/sync',   payload: '{"action":"SYNC"}' },
  ...
  function saveHistory() { localStorage.setItem('ctrl_history', JSON.stringify(history)); }

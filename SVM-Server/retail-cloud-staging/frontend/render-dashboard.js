...
(function () {
  ...
  function render(container) {
    container.innerHTML =
      '<div class="dashboard">' +
        '<div class="stat-cards" id="stat-cards">' +
          ...
          '<div class="stat-card danger"><div class="stat-value skeleton"></div><div class="stat-label">未处理异常</div></div>' +
        '</div>' +
    ...
    var onAnomaly = function () { loadStats(); loadAlerts(); };
    ...
    App._mqttOff.push(function () {
      ...
      App.MQTT.off('retail/+/event/anomaly', onAnomaly);
  ...
  function loadStats() {
    ...
    Promise.all([
      ...
      var results = r[0], anomalies = r[1], products = r[2];
      // 单层架构，直接统计
      var lowCount = 0;
      ...
      cards[3].textContent = anomalies.length;
  ...
  function loadAlerts() {
    ...
    Promise.all([
      ...
      var restock = r[0].slice(0, 3), anomalies = r[1].slice(0, 3);
